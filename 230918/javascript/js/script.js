// console.log(): 개발자 도구에서 값을 확인할 때 사용한다
// 숫자, 변수, 문자 등등 많은 것을 넣어서 확인할 수 있다.
/*
주석을 여러줄로 넣을 때는 이런 방식으로 
넣어주면 됩니다.
*/
console.log('안녕하세요');
...
let this_is_use_name;

// kebak case: 사용하지 않는다.
// let this-is-user-name;

// pacal case: 모든 단어의 첫글자를 대문자로
let ThisIsUserName;

// camel case: 낙타등같이 생겼다고 해서 camel case
let thisIsUserName;
...
// 고양이 : 보름이, 반달이, 밤이
const catName = '보름이';
// 상수(constant)로 선언된 값은 중간에 바꿀 수가 없다.
// 상수는 값이 변하면 안되는 경우에 사용
console.log(catName);
